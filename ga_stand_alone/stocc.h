...
#include "pga_error.h"  // V.M. [in order to replace FatalError with a GA exception]
...
#define STOC_BASE CRandomSFMTA0   // define random number generator base class      ////  V.M. [here I chose a "binary class"]
